...
<div class="row wizard-container">
    <div class="col-md-6">
        <div class="card wizard-card" data-color="blue" id="wizardProfile" style="background-color: rgb(255 255 255 / 96%);">
    ...
    <div class="col-md-5 text-blockl card" style="margin: 15% 0px 0px 67px;">
        <div class="rounded-right p-3" style="text-align: center; color: white;">
            <div class="overlay rounded-right"></div>
            <div class="account-testimonial" style="padding: 30px;">
                <h4 class="text-purple mb-4">You're on the best place for meeting new people nearby!
                    Chat, Flirt, Socialize and have Fun!</h4>
                <p class="lead text-purple">"Meet amazing people nearby Waiting for you...!"</p>
            </div>
        </div>
    </div>
